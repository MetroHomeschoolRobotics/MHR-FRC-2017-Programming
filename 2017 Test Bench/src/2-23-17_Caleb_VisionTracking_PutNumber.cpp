...
//		double centerPos2 = (LInner + RInner) / 2;
		...
		void RobotInit() override
		{
			...
			LOuter = roboRealm->PutNumber("X1", 1);
//			LInner = roboRealm->GetNumber("LeftInner", 1);
			ROuter = roboRealm->PutNumber("X3", 1);
//			RInner = roboRealm->GetNumber("RightInner", 1);

			shootDistance = roboRealm->PutNumber("Distance", 0); //CHANGE THIS TO THE CORRECT VARIABLE BEING SENT FROM ROBOREALM
		}
		...
		// the robot is enabled in teleop mode)
		{
			...
			if (driveStick->GetRawButton(6))
			{
				...
				{
					SmartDashboard::PutNumber("Vision Says", "Turn Left!!!");
					leftDrive1->Set(-0.5);
					leftDrive2->Set(-0.5);
					rightDrive1->Set(-0.5);
					rightDrive2->Set(-0.5);
				...
				if (imageCenter < centerPos)
				{
					SmartDashboard::PutNumber("Vision Says", "Turn Right!!!");
					leftDrive1->Set(0.5);
					leftDrive2->Set(0.5);
					rightDrive1->Set(0.5);
					rightDrive2->Set(0.5);
				...
				{/*
				 ...
				 {*/
					SmartDashboard::PutNumber("Vision Says", "Good!!!");
