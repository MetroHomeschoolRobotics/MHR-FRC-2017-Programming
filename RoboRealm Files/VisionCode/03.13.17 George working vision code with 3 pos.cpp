...
class Robot: public IterativeRobot
{
	...
	private:
		...
		double targetCenter = 205; // change me for the target center *note camera is offset
		...
		void FindGear() {
			...
			SmartDashboard::PutNumber("DB/String 0", LOuter);
			SmartDashboard::PutNumber("DB/String 1", LInner);
			SmartDashboard::PutNumber("DB/String 2", RInner);
			SmartDashboard::PutNumber("DB/String 3", ROuter);
			SmartDashboard::PutNumber("DB/String 4", shootDistance);
//			if (action == 1)
